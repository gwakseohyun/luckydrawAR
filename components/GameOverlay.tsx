...
// Custom Icon for Hand Gesture (Dashed Outline Style)
                ...
                <>
                   ...
                   {isDetecting && canStart && (
                       <div className="bg-yellow-400 text-black px-5 py-2.5 rounded-full text-sm font-bold shadow-[0_0_20px_rgba(250,204,21,0.6)] flex items-center gap-3 animate-pulse border-2 border-white/20">
                          ...
                          <span>손바닥과 손등을 번갈아 2번 보여주세요</span>
                       </div>
                   )}
                   ...
                   {isDetecting ? (
                       <div className="flex flex-col gap-2 items-center">
                         ...
                         <p className="text-lg text-white/90">
                            시작하려면 대표 1명이 <br/>
                            <span className="text-yellow-400 font-bold underline underline-offset-4">손바닥과 손등을 번갈아 2번</span> 보여주세요
                         </p>
                       </div>
                   ) : (
